...
sap.ui.controller("com.kaust.zui5approvers.controller.FinalExitVisa", {
  onInit: function () {
...
//		that.getView().byId("idBoarderNum").setValue(EmpJson.BorderNumber);
...
//				that.getView().byId("idDateofEntrance").setValue(day);
//				that.getView().byId("idBoarderNum").setValue(dataHeader[i].BorderNo);
//				that.getView().byId("idpassportIssplace").setValue(dataHeader[i].IqamaNo);
				
				var sponsFlag = dataHeader[i].SponsorshipCheckFlag;
				that.getView().byId("fev_sps").setVisible(true);
				that.getView().byId("fev_car").setVisible(true);
				that.getView().byId("fev_vis").setVisible(true);
				
				if (sponsFlag === "" || sponsFlag === null) {
					that.getView().byId("fev_sponsorshipflag").setText("No");
				} else if (sponsFlag === "X") {
					that.getView().byId("fev_sponsorshipflag").setText("Yes");
				}

				var carFlag = dataHeader[i].RequestTypeFlag;
				if (carFlag === "" || sponsFlag === null) {
					that.getView().byId("fev_carflag").setText("No");
				} else if (carFlag === "X") {
					that.getView().byId("fev_carflag").setText("Yes");
				}
				
				var key = dataHeader[i].VisitorCheckFlag;
				if (key === "" || key === null) {
					that.getView().byId("fev_visitorflag").setText("No");
//					var date = new Date(dataHeader[i].DateOfEntrance);
//					var month = date.getMonth() + 1;
//					var day = date.getDate() + "-" + month + "-" + date.getFullYear();
				} else if (key === "X") {
					that.getView().byId("fev_visitorflag").setText("Yes");
				}
				
			} else if (RequestorTypeFlag === "D") {
				that.getView().byId("fev_requstorflag").setText("Dependent");
//				that.getView().byId("idbDateofEntrance").setVisible(false);
				that.getView().byId("idbBoarderNum").setVisible(false);
//				that.getView().byId("idbiqamano").setVisible(false);
				that.getView().byId("fev_sps").setVisible(false);
				that.getView().byId("fev_car").setVisible(false);
				that.getView().byId("fev_vis").setVisible(false);
