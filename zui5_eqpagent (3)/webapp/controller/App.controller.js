sap.ui.define([
    ...
    function (Controller) {
        ...
        return Controller.extend("com.kaust.zui5eqpagent.controller.App", {
            onInit: function () {
		    ...
		    * route pattern matched**/
            ...
            _updateUIElements: function () {
                ...
                if (oUIState.layout === "TwoColumnsMidExpanded") {
                    ofcl.addStyleClass("TwoColumnsMidLayout");
                } else {
                    ofcl.removeStyleClass("TwoColumnsMidLayout");
                }
